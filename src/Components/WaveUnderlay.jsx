...
const WaveUnderlay = () => {
    ...
    useEffect(() => {
        ...
        if (waveElement) {
            waveElement.setAttribute("aria-hidden", waveUnderlayState.toString())
        }
    }, [waveUnderlayState]);


    return (<div id="waveOverlay" className="  flex flex-col h-screen ">
        ...
        <div className="h-[50vh] bg-primary_wave_light dark:bg-primary_wave_dark">
        </div>
    </div>)
}
