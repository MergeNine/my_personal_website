        ...
        <header className="text-black dark:text-white p-6  lg:max-w-[1024px] lg:min-w-[768px] mx-auto">
            ...
            <nav className="flex justify-between items-center py-2">
                ...
                <ul className="flex space-x-6">
                    <li>
                        <svg className=" fill-blue-700 dark:fill-blue-200  " height="25px" width="25px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60">
                    ...
                    <li title="Github">
                        <svg className="fill-blue-700 dark:fill-blue-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" width="25" height="25">
                    ...
                    <li title="Linkedin">
                        <svg className="fill-blue-700 dark:fill-blue-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" height="25" width="25">
