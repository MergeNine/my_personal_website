...
const Bio = () => {
    ...
    text-black dark:text-neutral-300">
            ...
            border-light_accent dark:border-dark_accent ">Bio</span>
                ...
                <p className="font-normal max-w-[420px] sm:max-w-[435px]
        text-primary_text_light dark:text-primary_text_dark">
                    <ul>
                        <li className="flex items-start mb-1">
                            <div className="font-semibold w-[4.25rem] sm:w-20">1989</div>
                            <div>Born in Media, PA</div>
                        </li>
                        <li className="flex items-start mb-1">
                            <div className="font-semibold w-[4.25rem] sm:w-20">2012</div>
                            <div>B.S.Chemistry at Widener</div>
                        </li>
                        <li className="flex items-start mb-1">
                            <div className="font-semibold w-[4.25rem] sm:w-20 ">2017</div>
                            <div>M.S. in Chemistry at UPenn</div>
                        </li>
                        <li className="flex items-start mb-1">
                            <div className="font-semibold w-[4.25rem] sm:w-20">2019</div>
                            <div>Chemist in Drug-Discovery</div>
                        </li>
                        <li className="flex items-start mb-1">
                            <div className="font-semibold w-[4.25rem] sm:w-20">2022</div>
                            <div>Android Development</div>
                        </li>
                        <li className="flex items-start mb-1">
                            <div className="font-semibold w-[4.25rem] sm:w-20">2024</div>
                            <div>Web Development</div>
                        </li>
                        <li className="flex items-start mb-1">
                            <div className="font-semibold w-[4.25rem] sm:w-20">Pres.</div>
