    ...
    return (
        <article className=" bg-primary_light dark:bg-primary_dark">
            <div className="  max-w-5xl  mx-auto bg-primary_light pt-12 dark:bg-primary_dark  ">
                <div
                    className="gap-6 mx-auto sm:px-8  sm:max-w-2xl">
                    ...
                    <div className="mx-12 flex flex-col ">
                        ...
                        <div className="sm:flex sm:items-start justify-between  max-w-[415px] ">
                            ...
                            <div className="flex justify-center items-center p-4 max-w-md">
                        ...
                        <div className="mt-2 flex flex-col gap-y-4 px-2  font-[600] text-black dark:text-neutral-300">
                            ...
                            <p className="flex flex-col gap-2  text-base  max-w-[400px] sm:max-w-[435px] text-justify tracking-tighter
